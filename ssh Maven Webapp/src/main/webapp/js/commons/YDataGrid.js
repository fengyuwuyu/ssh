...
var YDataGrid = function(config){
		...
		var initGrid = function(){
			...
			var pageSize  = dataGrid.pageSize?dataGrid.pageSize:15;
			var pageList = dataGrid.pageList?dataGrid.pageList:[15,30,45,60];
			var dataconfig = {
				title:showGridTitle?dataGrid.title || '数据表格':null,
				iconCls:dataGrid.iconCls || 'icon-grid',
				height:dataGrid.height || 465,
				width:dataGrid.width||YiYa.fixWidth()-(dataGrid.subWidth?dataGrid.subWidth:0),
				...
				onDblClickCell : dataGrid.onDblClickCell||null,
